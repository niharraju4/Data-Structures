...
public class MyDeque {
  ...
  if(N==0)
  {
    //both first and last Node will be same
    first = newNode;
    last = newNode;
    first.next = null;
    first.prev = null;
  ...
  else
  {
    ...
    Node temp= first;
    //make second item as first
    first = first.next;
    //reduce the count
    N--;

    //if queue become empty then make last =null
    if(isEmpty()) {
            last = null;
    } else {
            //make previous null
    ...
    public int popRight () {
     ...
     Node temp= last;
     //make second last item as last
     last = last.prev;
     //reduce the count
     N--;

     //if queue become empty then make first =null
     if(isEmpty()) {
             first = null;
     } else {
             //make  last next null
